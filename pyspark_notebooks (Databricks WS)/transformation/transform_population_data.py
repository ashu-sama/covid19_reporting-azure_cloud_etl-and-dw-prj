...
df_raw_population = (spark.read
                        ...
                        .load(path="/mnt/covid19prjdls/raw/population/population_by_age.tsv", header=True, sep=r"\t"))
...
df_raw_population = (df_raw_population
                     .select(col("country_code").alias("country_code"),
...
df_raw_population_pivot = (spark
                            .sql("""SELECT 
                                        country_code, 
                                        age_group, 
                                        cast(regexp_replace(percentage_2019, '[a-z]', '') AS decimal(4,2)) AS percentage_2019 FROM raw_population
                                    WHERE 
...
df_dim_country = spark.read.csv("/mnt/covid19prjdls/lookup/dim_country", sep=r',', header=True)
...
(df_processed_population.write
                        ...
                        .option("delimiter", ",")
                        .mode("overwrite")
                        .save("/mnt/covid19prjdls/processed/population"))